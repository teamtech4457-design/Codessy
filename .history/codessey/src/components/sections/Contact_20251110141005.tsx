      ...
      <div className="contact-container">
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            <div>
              ...
              <p className="contact-info-description">
                We&apos;re here to help you bring your vision to life. Reach out and let&apos;s discuss how we can
          ...
          <form onSubmit={handleSubmit} className="contact-form">
            ...
            <div className="form-field">
              <label htmlFor="queryMessage" className="form-label">Query Message</label>
              <textarea
                id="queryMessage"
                name="queryMessage"
