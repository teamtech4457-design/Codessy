...
import './contact.css'
import axios from 'axios'; // Import upar add kijiye
...
export default function Contact({ onVisible }: ContactProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: '', email: '', message: '', queryMessage: '' })  // reset naya field bhi
  }
      ...
      <div className="contact-container">
        ...
        <div className="contact-grid">
          ...
          <form onSubmit={handleSubmit} className="contact-form">
            ...
            {/* Query Message Section: Add below Your Message */}
            <div className="form-field">
